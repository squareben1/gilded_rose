...
describe("Gilded Rose w/ Conjured Mana Cake Feature", function() {
...
Conjured Mana Cake, 3, 6\n`
  ...
  it("should return several items after 2 days", function() {
    const items = [
      new Item("+5 Dexterity Vest", 10, 20), //
      new Item("Aged Brie", 2, 0), //
      new Item("Elixir of the Mongoose", 5, 7), //
...
`
  ...
  it("should return several items after 30 days", function() {
    const items = [
      new Item("+5 Dexterity Vest", 10, 20), //
      new Item("Aged Brie", 2, 0), //
      new Item("Elixir of the Mongoose", 5, 7), //
